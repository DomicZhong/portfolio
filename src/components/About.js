...
import dev from '../images/Developer.jpg';
        ...
        <Container fluid style={{height: "75vh"}} id="about">
            ...
            <Row style={{justifyContent: "center", alignItems: "center", height: "80%"}}>
                ...
                <Col sm={9} md={10} lg={{ span: 5, offset: 1}}>
                    <h1>Hi! I am Allen ZHONG</h1>
                    <h4 style={{fontWeight: "300"}}>
                        I am a student at The Hong Kong Polytechnic Uuniversity, studying Urban Informatics.
                        I love to code and study technology in my spare time.
                    </h4>
                </Col>
            </Row>
        </Container>
